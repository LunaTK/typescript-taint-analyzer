...
function getLabs(req: express.Request, res: express.Response) {
  async.waterfall([
...
function deleteLab(req: express.Request, res: express.Response) {
  log.info('[DELETE LAB]');
  async.waterfall([
    // Check if repo dir parameter exists
...
function getInformation(req: express.Request, res: express.Response) {
...
function wantToRename(req: express.Request, res: express.Response) {
...
//      cb(null);
//    },
function saveInformation(req: express.Request, res: express.Response) {
...
function newLab(req: express.Request, res: express.Response) {
  log.info('[NEW LAB]');
  async.waterfall([
    // Check if repo dir parameter exists
    (cb) => checkParams(req.params, req.body, cb),
...
function copyLab(req: express.Request, res: express.Response) {
  let i = 1;
  let newLabName;
  log.info('[ COPY LAB ]');
  async.waterfall([
...
function importLab(req: express.Request, res: express.Response) {
  log.info('[ IMPORT LAB ]');
  let destPath;
  let srcPath;
