/**
 * https://github.com/FineUploader/server-examples/blob/3ada78700b8d913be5ad8c9ddf3183c9a23e7fe6/nodejs/nodejs.js#L134
...
function onDeleteFile(req: express.Request, res: express.Response) {
...
function onUpload(req: express.Request, res: express.Response) {
